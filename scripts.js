...
function calcularROI() {
  ...
  const retorno           = (economiaMensal / custoAFLORMensal).toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 });
  ...
  document.getElementById('payback').textContent             = payback.toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 });
  ...
  document.getElementById('rp_payback').textContent     = payback.toLocaleString('pt-BR', { minimumFractionDigits: 1, maximumFractionDigits: 1 }) + ' meses';
  ...
  const percReducao = ((economiaMensal / custoManualMensal) * 100).toLocaleString('pt-BR', { minimumFractionDigits: 0, maximumFractionDigits: 0 });
    ...
    <div class="doc-narrative">
      ...
      <div class="narrative-block accent">
        ...
        <div class="narrative-text">
          ...
          com <strong>Tempo de Recuperação em apenas ${payback.toLocaleString('pt-BR', { minimumFractionDigits: 1, maximumFractionDigits: 1 })} meses</strong>.
        </div>
      </div>
      <div class="narrative-block accent-b">
        <div class="narrative-heading"> Análise de Eficiência Operacional</div>
        <div class="narrative-text">
          O <strong>Potencial de Recuperação de ${roiPercentual.toLocaleString('pt-BR', { minimumFractionDigits: 1, maximumFractionDigits: 1 })}%</strong> indica que, <strong>para cada R$ 1,00 investido, a empresa obtém R$ ${retorno} em economia operacional</strong>. Trata-se de um índice elevado de retorno, com forte impacto em projetos e operações baseadas em dados.
        </div>
      </div>
      <div class="narrative-block">
  ...
  document.getElementById('pr_payback').textContent    = payback.toLocaleString('pt-BR', { minimumFractionDigits: 1, maximumFractionDigits: 1 }) + ' meses';
